...
class FormUser extends React.Component {
    ...
    handleSubmit = async (e) => {
        ...
        let weatherData = await axios.get(`https://cityexplorerapilaith.herokuapp.com/weather?lat=${lat}&lon=${lon}&searchQuery=${userInput}`);
        try {
            this.setState({
        ...
        let movieData = await axios.get(`https://cityexplorerapilaith.herokuapp.com/movies?title=${userInput}`);
        try {
            this.setState({
